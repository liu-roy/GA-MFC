================================================================================
MICROSOFT 基础类库: mfcdemo 项目概述
===============================================================================

应用程序向导已为您创建了这个 mfcdemo 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。

本文件概要介绍组成 mfcdemo 应用程序的每个文件的内容。
...
res\mfcdemo.ico
这是用作应用程序图标的图标文件。此图标包括在主要资源文件 mfcdemo.rc 中。
...
mfcdemoDlg.h，mfcdemoDlg.cpp - 对话框
这些文件包含 CmfcdemoDlg 类。该类定义应用程序主对话框的行为。该对话框的模板位于 mfcdemo.rc 中，该文件可以在 Microsoft Visual C++ 中进行编辑。
...
StdAfx.h，StdAfx.cpp
这些文件用于生成名为 mfcdemo.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
